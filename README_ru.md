...
[![Уровень интеграции](https://apps.yunohost.org/badge/integration/matrix-appservice-irc)](https://ci-apps.yunohost.org/ci/apps/matrix-appservice-irc/)
![Состояние работы](https://apps.yunohost.org/badge/state/matrix-appservice-irc)
![Состояние сопровождения](https://apps.yunohost.org/badge/maintained/matrix-appservice-irc)
...
**Поставляемая версия:** 3.0.5~ynh1
