...
![Estado funcional](https://apps.yunohost.org/badge/state/matrix-appservice-irc)
![Estado En Mantención](https://apps.yunohost.org/badge/maintained/matrix-appservice-irc)
