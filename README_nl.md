...
[![Integratieniveau](https://apps.yunohost.org/badge/integration/matrix-appservice-irc)](https://ci-apps.yunohost.org/ci/apps/matrix-appservice-irc/)
![Mate van functioneren](https://apps.yunohost.org/badge/state/matrix-appservice-irc)
![Onderhoudsstatus](https://apps.yunohost.org/badge/maintained/matrix-appservice-irc)
